...
const carouselItems = [
  { id: 1, title: "SGitHub Actions", description: "Para CI/CD.", icon: IconGitHub },
  { id: 2, title: "Docker + Compose", description: "Gerenciamento de containers, e orquestração local.", icon: IconDocker },
  { id: 3, title: "Railway, Render, Vercel, Netlify", description: "Para deploy de apps.", icon: IconDeploy },
  { id: 4, title: "AWS, GCP ou Azure", description: "Para maior segurança e organização do código.", icon: IconAWS },
  { id: 5, title: "Linux", description: "Para persistência de dados.", icon: IconLinux },
  { id: 6, title: "Monitoramento", description: "Como Grafana, Logtail, ou ferramentas simples.", icon: IconMonitoring }
];
...
const DevopsView = () => {
    ...
    return (
        ...
        >
            ...
            <Title id="devops-heading" size={40}>DevOps</Title>

            <Text size={20} color="#323232" weight={400}>
                A área de DevOps é o elo entre o desenvolvimento de software e a operação dos sistemas. 
                O objetivo é garantir que os produtos sejam entregues de forma segura, contínua e escalável, 
                sem fricção entre o que o time desenvolve e o que vai para produção.
            </Text>

            <Text size={20} color="#323232" weight={400}>
                Se você gosta de automação, infraestrutura, monitoramento e processos, essa área pode ser a sua.
            </Text>
